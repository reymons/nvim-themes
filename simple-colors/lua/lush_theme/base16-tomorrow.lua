...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Type                    { fg = hsl(0, 0, 54) },
    Visual                  { bg = hsl(0, 0, 37) },
    String                  { fg = hsl(40, 40, 68) },
    LineNr                  { fg = hsl(120, 1, 59) },
    StatusLine              {
                                fg = hsl(0, 0, 6),
                                bg = hsl(0, 0, 13)
                            },
    ...
    Directory               { fg = Keyword.fg },
    EndOfBuffer             { fg = Normal.bg },
    MatchParen              {},
    SignColumn              {},
    StatusLineNC            { fg = Normal.bg, bg = StatusLine.bg },
    TabLine                 { },
    TabLineFill             { },
    CursorLine              { },
    NonText                 { Identifier },
    ...
    Pmenu          { bg = hsl(0, 0, 15) }, -- Popup menu: Normal item.
    PmenuSel       { bg = hsl(0, 0, 25) }, -- Popup menu: Selected item.
